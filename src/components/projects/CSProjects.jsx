...
const CSProjects = () => {
    ...
    // console.log(project);
    const { image, title, project_description, my_role, demo, github } = project || {}; // Destructure image from the project object, default to an empty object if project is not found
